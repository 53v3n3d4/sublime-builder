 ...
 */
function writeStFile (jsonFile, title, author, licenseName, filename, keyname, tabSpace) {
  try {
 ...
 * @param {number} tabSpace - Indentation used on build file, tab spaces. Max number = 10.
 * replaced.
 * @example theme,
 * builder(
 *   'merge',
...
export function builder (
  ...
  } else if (typeof tabSpace === 'string' || tabSpace > 10 || typeof tabSpace === 'boolean' ||
