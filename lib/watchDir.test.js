...
import { fileThemeMerge, mockPath, themeColors, themeData, themeRules, themeVars }
...
describe('watchDir test', () => {
  ...
  test('test watchDir parameters', () => {
    const watcher = watchDir(themeWatch.folderPath, themeWatch.folder, themeWatch.themes, buildFile)
